...
echo "JAVA_HOME : "  $ORACLE_GUI_JAVA_HOME

# Set the direnctory containing the jar file to execute
ORACLE_GUI_JAR_DIR="./"

#Set the jar file name
ORACLE_GUI_JAR_NAME="oracle-gui-1.0-BETA-1.2-jar-with-dependencies.jar"
echo "JAR Name : " $ORACLE_GUI_JAR_DIR$ORACLE_GUI_JAR_NAME
...
# Execute java
$_JAVA_EXEC -Xmx${MAXIMUM_HEAP_SIZE} -jar "$ORACLE_GUI_JAR_DIR$ORACLE_GUI_JAR_NAME" "$@" > startup.log
