...
public final class MysqlMetaQueryConstants {
	...
	public static final String GET_ALL_TABLE_NAMES_BY_SCHEMA_SQL = "SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA=?";
	...
	public static final String GET_COLUMN_LIST_SQL = "SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = ? AND TABLE_NAME = ?";

	public static final String GET_ALL_CONSTRAINTS_SQL = "SELECT * FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_SCHEMA = ? AND TABLE_SCHEMA = ? AND TABLE_NAME = ?";
}
